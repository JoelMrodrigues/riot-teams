...
interface TftPlayerParams {
  gameName: string;
  tagLine: string;
  [key: string]: string | undefined;
}

export function TftPlayerPage(): React.JSX.Element {
  const { gameName, tagLine } = useParams<TftPlayerParams>();
      ...
      <div className="flex-1 flex flex-col px-8 py-10 gap-8 overflow-y-auto">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: 'Rajdhani, sans-serif' }}
          >
            Teamfight Tactics · Profil joueur
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            >
              Intégration API Riot Games — Phase 6
            </p>
            <p
